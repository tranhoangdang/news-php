<?php
    ...
    if(isset($_POST['add'])){
        ...
        $sql = "UPDATE subcategories SET name='$name', categoryID='$category', is_active='$status' WHERE id=$id";

        if($conn->query($sql) === TRUE){
            set_flash_session('mess_flash','Chủ đề đã được chỉnh sửa.');
            redirect('edit-subcategory.php?id='.$id);
        }
        else{
            $error = $conn->error;
        }
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 mb-3 border-bottom">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Chỉnh sửa chủ đề</li>
                        </ol>
                    </nav>
                </div>
                <?php
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="category">
                            <?php
                                ...
                                FROM categories JOIN subcategories ON categories.id=subcategories.categoryID
