<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO categories(name,is_active) VALUES ('$name','$status')";

        if ($conn->query($sql) === TRUE) {
            set_flash_session('mess_flash', 'Chuyên mục đã được thêm.');
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 mb-3 border-bottom">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Thêm chuyên mục</li>
                        </ol>
                    </nav>
                </div>
                <?php
                ...
                <form method="post">
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Nhập tên chuyên mục" name="name" required>
                    </div>
                    <div class="mb-3">
